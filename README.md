...
This webapp requires SAML authentication to be configured to be able to log in to the app and use its functionality.

Adjust the application-*.yml files for each environment for your SAML SP and IdP configurations
...
To optimize the meetme application for production, run:
